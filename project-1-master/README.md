...
App TITLE - Genshin Chara bio
App Desc - Will show Charaters name,element,vision(element),rarity and their abilities.
API - https://api.genshin.dev
API Snippet - ??
Wirefranes - It will be a desktop application first then i will work on a mobile version
...
2. This new repo should be under your personal Github, NOT your Enterprise GA account.
